...
1. **Discover Available Skills**:
   ...
   - For maximum compatibility, check project/workspace skill directories in `.agents/skills/**/SKILL.md`, `.agents/skills/**/SKILL.md`, and `.agents/skills/**/SKILL.md`
   - Also check user/home skill directories in `~/.agents/skills/**/SKILL.md`, `~/.agents/skills/**/SKILL.md`, and `~/.agents/skills/**/SKILL.md`
