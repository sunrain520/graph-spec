...
// Security review
Task({
  subagent_type: "`.codex/agents/review/security-sentinel.md`",
...
// Performance review
Task({
  subagent_type: "`.codex/agents/review/performance-oracle.md`",
...
// Rails code review
Task({
  subagent_type: "`.codex/agents/review/kieran-rails-reviewer.md`",
...
// Architecture review
Task({
  subagent_type: "`.codex/agents/review/architecture-strategist.md`",
...
// Code simplicity
Task({
  subagent_type: "`.codex/agents/review/code-simplicity-reviewer.md`",
...
Task({
  subagent_type: "`.codex/agents/research/best-practices-researcher.md`",
...
Task({
  subagent_type: "`.codex/agents/research/framework-docs-researcher.md`",
...
Task({
  subagent_type: "`.codex/agents/research/git-history-analyzer.md`",
...
```javascript
Task({
  subagent_type: "`.codex/agents/design/figma-design-sync.md`",
...
```javascript
Task({
  subagent_type: "`.codex/agents/workflow/bug-reproduction-validator.md`",
