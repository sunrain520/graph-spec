...
- Read `.codex/agents/research/repo-research-analyst.md` and apply that agent profile to: Scope: technology, architecture, patterns. {planning context summary}
- Read `.codex/agents/research/learnings-researcher.md` and apply that agent profile to: planning context summary
...
- Read `.codex/agents/research/best-practices-researcher.md` and apply that agent profile to: planning context summary
- Read `.codex/agents/research/framework-docs-researcher.md` and apply that agent profile to: planning context summary
...
- Read `.codex/agents/workflow/spec-flow-analyzer.md` and apply that agent profile to: planning context summary, research findings
...
- `.codex/agents/workflow/spec-flow-analyzer.md` for missing user flows, edge cases, and handoff gaps
- `.codex/agents/research/repo-research-analyst.md` (Scope: `architecture, patterns`) for repo-grounded patterns, conventions, and implementation reality checks

**Context & Research / Sources & References gaps**
- `.codex/agents/research/learnings-researcher.md` for institutional knowledge and past solved problems
- `.codex/agents/research/framework-docs-researcher.md` for official framework or library behavior
- `.codex/agents/research/best-practices-researcher.md` for current external patterns and industry guidance
- Add `.codex/agents/research/git-history-analyzer.md` only when historical rationale or prior art is materially missing

**Key Technical Decisions**
- `.codex/agents/review/architecture-strategist.md` for design integrity, boundaries, and architectural tradeoffs
- Add `.codex/agents/research/framework-docs-researcher.md` or `.codex/agents/research/best-practices-researcher.md` when the decision needs external grounding beyond repo evidence

**High-Level Technical Design**
- `.codex/agents/review/architecture-strategist.md` for validating that the technical design accurately represents the intended approach and identifying gaps
- `.codex/agents/research/repo-research-analyst.md` (Scope: `architecture, patterns`) for grounding the technical design in existing repo patterns and conventions
- Add `.codex/agents/research/best-practices-researcher.md` when the technical design involves a DSL, API surface, or pattern that benefits from external validation

**Implementation Units / Verification**
- `.codex/agents/research/repo-research-analyst.md` (Scope: `patterns`) for concrete file targets, patterns to follow, and repo-specific sequencing clues
- `.codex/agents/review/pattern-recognition-specialist.md` for consistency, duplication risks, and alignment with existing patterns
- Add `.codex/agents/workflow/spec-flow-analyzer.md` when sequencing depends on user flow or handoff completeness

**System-Wide Impact**
- `.codex/agents/review/architecture-strategist.md` for cross-boundary effects, interface surfaces, and architectural knock-on impact
- Add the specific specialist that matches the risk:
  - `.codex/agents/review/performance-oracle.md` for scalability, latency, throughput, and resource-risk analysis
  - `.codex/agents/review/security-sentinel.md` for auth, validation, exploit surfaces, and security boundary review
  - `.codex/agents/review/data-integrity-guardian.md` for migrations, persistent state safety, consistency, and data lifecycle risks

**Risks & Dependencies / Operational Notes**
- Use the specialist that matches the actual risk:
  - `.codex/agents/review/security-sentinel.md` for security, auth, privacy, and exploit risk
  - `.codex/agents/review/data-integrity-guardian.md` for persistent data safety, constraints, and transaction boundaries
  - `.codex/agents/review/data-migration-expert.md` for migration realism, backfills, and production data transformation risk
  - `.codex/agents/review/deployment-verification-agent.md` for rollout checklists, rollback planning, and launch verification
  - `.codex/agents/review/performance-oracle.md` for capacity, latency, and scaling concerns
