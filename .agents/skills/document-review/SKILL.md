...
Always include:
- `.codex/agents/document-review/coherence-reviewer.md`
- `.codex/agents/document-review/feasibility-reviewer.md`

Add activated conditional personas:
- `.codex/agents/document-review/product-lens-reviewer.md`
- `.codex/agents/document-review/design-lens-reviewer.md`
- `.codex/agents/document-review/security-lens-reviewer.md`
- `.codex/agents/document-review/scope-guardian-reviewer.md`
- `.codex/agents/document-review/adversarial-document-reviewer.md`
