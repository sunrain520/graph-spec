...
| Agent | Focus |
|-------|-------|
| `.codex/agents/review/correctness-reviewer.md` | Logic errors, edge cases, state bugs, error propagation |
| `.codex/agents/review/testing-reviewer.md` | Coverage gaps, weak assertions, brittle tests |
| `.codex/agents/review/maintainability-reviewer.md` | Coupling, complexity, naming, dead code, abstraction debt |
| `.codex/agents/review/project-standards-reviewer.md` | CLAUDE.md and AGENTS.md compliance -- frontmatter, references, naming, portability |
| `.codex/agents/review/agent-native-reviewer.md` | Verify new features are agent-accessible |
| `.codex/agents/research/learnings-researcher.md` | Search docs/solutions/ for past issues related to this PR |

**Cross-cutting conditional (selected per diff):**

| Agent | Select when diff touches... |
|-------|---------------------------|
| `.codex/agents/review/security-reviewer.md` | Auth, public endpoints, user input, permissions |
| `.codex/agents/review/performance-reviewer.md` | DB queries, data transforms, caching, async |
| `.codex/agents/review/api-contract-reviewer.md` | Routes, serializers, type signatures, versioning |
| `.codex/agents/review/data-migrations-reviewer.md` | Migrations, schema changes, backfills |
| `.codex/agents/review/reliability-reviewer.md` | Error handling, retries, timeouts, background jobs |
| `.codex/agents/review/adversarial-reviewer.md` | Diff >=50 changed non-test/non-generated/non-lockfile lines, or auth, payments, data mutations, external APIs |

**Stack-specific conditional (selected per diff):**

| Agent | Select when diff touches... |
|-------|---------------------------|
| `.codex/agents/review/dhh-rails-reviewer.md` | Rails architecture, service objects, session/auth choices, or Hotwire-vs-SPA boundaries |
| `.codex/agents/review/kieran-rails-reviewer.md` | Rails application code where conventions, naming, and maintainability are in play |
| `.codex/agents/review/kieran-python-reviewer.md` | Python modules, endpoints, scripts, or services |
| `.codex/agents/review/kieran-typescript-reviewer.md` | TypeScript components, services, hooks, utilities, or shared types |
| `.codex/agents/review/julik-frontend-races-reviewer.md` | Stimulus/Turbo controllers, DOM events, timers, animations, or async UI flows |

**CE conditional (migration-specific):**

| Agent | Select when diff includes migration files |
|-------|------------------------------------------|
| `.codex/agents/review/schema-drift-detector.md` | Cross-references schema.rb against included migrations |
| `.codex/agents/review/deployment-verification-agent.md` | Produces deployment checklist with SQL verification queries |
